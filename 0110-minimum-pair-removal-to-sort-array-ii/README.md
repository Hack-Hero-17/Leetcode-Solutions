<h2><a href="https://leetcode.com/problems/minimum-pair-removal-to-sort-array-ii">110. Minimum Pair Removal to Sort Array II</a></h2><h3>Hard</h3><hr><p>Given an array <code>nums</code>, you can perform the following operation any number of times:</p>
